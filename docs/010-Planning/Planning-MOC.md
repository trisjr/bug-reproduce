...
- 🚀 **`P0-A` — Spike Protocol đã KHỞI ĐỘNG 2026-08-15.** Run container: [pm-runs/2026-08-15-p0a-spike-protocol](./pm-runs/2026-08-15-p0a-spike-protocol/brief.md) (T3, 9.5 MD, `W1`–`W2`). Đây là phase **duy nhất đã được cấp vốn**; `Gate A` trình cuối `W2` (~2026-08-28).
  - **Một open question chặn chất lượng gate**: `GAP-Redis` (`OQ-1`) — §22 bắt spike app chạm Redis, §18/`C-03` không capture Redis, §22 lại bắt destroy environment ⇒ 10/10 scenario replay với input không được ghi. `A2` phải quyết tường minh **trước khi** spike chạy.
